...
namespace ShootMatchServer.Common
{

    public class SqlHelper
    {
        private static string connectionString = "Data Source=192.168.0.116;Initial Catalog=wb02;Persist Security Info=True;User ID=sa;Password=aBCD1234";//连接字符串
